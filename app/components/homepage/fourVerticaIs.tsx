            ...
            <div className="relative z-10 mx-auto flex h-full w-full flex-col justify-center">
                <div className="grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-8 lg:gap-12 w-full h-full items-center">
                    ...
                    <div className="flex flex-col justify-center space-y-2 sm:space-y-3 lg:space-y-4 xl:space-y-5 lg:pl-12 order-1 lg:order-2">
                        <h2 className="flex flex-col text-left font-sans text-4xl font-normal leading-[0.85] tracking-tighter text-black sm:text-5xl md:text-6xl lg:text-6xl xl:text-[7rem] transform scale-x-[1.15] origin-left pb-2 sm:pb-3 lg:pb-4">
                            <span>FOUR</span>
                            <span>VERTICALS.</span>
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-sm sm:text-xl lg:text-2xl xl:text-3xl font-medium text-black leading-[1.2] uppercase tracking-wide">
