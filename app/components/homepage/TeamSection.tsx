...
export default function TeamSection() {
    return (
        <div className="w-full max-w-7xl mx-auto flex flex-col items-center justify-center space-y-3 md:space-y-8 lg:space-y-10 xl:space-y-12">
            <div className="text-center sm:space-y-1 px-4">
